...
import defaultAvatar from '@src/assets/images/portrait/small/222.png'
...
const timeZoneOptions = [
  { value: '(GMT+02:00) International Date Line West', label: '(GMT+02:00) Belgrade/Bratislava/Ljubljana' },
          ...
          <Form className='mt-2 pt-50' onSubmit={handleSubmit(onSubmit)}>
            <Row>
              <Col sm='6' className='mb-1'>
                <Label className='form-label' for='firstName'>
                  First Name
                    ...
                    <Input id='firstName' placeholder='John' invalid={errors.firstName && true} defaultValue={"Ilija"} />
              ...
              <Col sm='6' className='mb-1'>
                <Label className='form-label' for='lastName'>
                  Last Name
                    ...
                    <Input id='lastName' placeholder='Doe' invalid={errors.lastName && true}  defaultValue={"Neskovic"}  />
              ...
              <Col sm='6' className='mb-1'>
                ...
                <Input id='emailInput' type='email' name='email' placeholder='Email' defaultValue={"neskoff@gmail.com"} />
              </Col>
              <Col sm='6' className='mb-1'>
                <Label className='form-label' for='company'>
                  University
                </Label>
                <Input defaultValue="Faculty Of Technical Sciences" id='company' name='company' placeholder='Company Name' />
              </Col>
              <Col sm='6' className='mb-1'>
              ...
              <Col sm='6' className='mb-1'>
                ...
                <Input id='address' name='address' value={"Svetog Save 66"} placeholder='12, Business Park' />
              </Col>
              <Col sm='6' className='mb-1'>
                <Label className='form-label' for='accountState'>
                  City
                </Label>
                <Input id='accountState' defaultValue={"Cacak"} name='state' placeholder='California' />
              </Col>
              <Col sm='6' className='mb-1'>
                <Label className='form-label' for='zipCode'>
                  Zip Code
                </Label>
                <Input id='zipCode' name='zipCode' defaultValue={"32000"} placeholder='123456' maxLength='6' />
              </Col>
              <Col sm='6' className='mb-1'>
